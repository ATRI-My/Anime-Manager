...
**Goal:** 合并现有的4个README文件（README.md、README-未打包程序.md、README-焦点修复版.md、README-TEST-DATA.md）为一个统一的README.md文件

**Architecture:** 创建新的README.md文件，标题为"# 动漫管理工具"，按逻辑结构合并内容：项目概述、功能特性、快速开始、未打包程序使用、焦点修复说明、测试数据

**Tech Stack:** Markdown文档合并

---

### Task 1: 创建新的README.md文件
...
运行: `cat README.md | head -10`
预期: 显示前10行内容，包含标题和功能特性

**Step 3: 提交创建的文件**

```bash
git add README.md
git commit -m "docs: 创建新的README.md文件结构"
```
...
运行: `cat README.md | grep -A 20 "## 快速开始"`
预期: 显示快速开始和项目结构部分
...
运行: `cat README.md | grep -A 30 "## 未打包程序使用"`
预期: 显示未打包程序使用说明
...
运行: `cat README.md | grep -A 50 "## 焦点修复详细说明"`
预期: 显示焦点修复详细说明
...
运行: `cat README.md | grep -A 40 "## 测试数据设置指南"`
预期: 显示测试数据设置指南
...
运行: `cat README.md | grep -A 30 "## 开发指南"`
预期: 显示开发指南和构建信息
...
```bash
git add README.md
git commit -m "docs: 添加开发指南和构建信息"
```

### Task 7: 删除旧的README文件

**Files:**
- Delete: `README-未打包程序.md`
- Delete: `README-焦点修复版.md`
- Delete: `README-TEST-DATA.md`

**Step 1: 删除旧文件**

```bash
rm README-未打包程序.md README-焦点修复版.md README-TEST-DATA.md
```
...
```bash
git add -u
git commit -m "docs: 删除旧的README文件"
```
...
**Step 1: 检查README.md完整性**

运行: `wc -l README.md`
预期: 文件行数大约在200-250行之间
...
运行: `head -20 README.md`
预期: 显示标题和功能特性

运行: `tail -10 README.md`
预期: 显示许可证信息
...
```bash
git add README.md
git commit -m "docs: 完成README合并，统一文档结构"
```

**Step 4: 显示最终状态**

运行: `git log --oneline -5`
预期: 显示最近的5个提交，包含README相关的提交
```